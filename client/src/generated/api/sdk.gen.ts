 ...
 */
export const passwordChangeRequests = <ThrowOnError extends boolean = false>(options: Options<PasswordChangeRequestsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PasswordChangeRequestsResponse, PasswordChangeRequestsError, ThrowOnError>({
