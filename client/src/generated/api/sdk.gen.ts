...
import type { GetArtToysData, GetArtToysResponse, GetArtToysError, CreateArtToyData, CreateArtToyResponse, CreateArtToyError, DeleteArtToyData, DeleteArtToyResponse, DeleteArtToyError, GetArtToyByIdData, GetArtToyByIdResponse, GetArtToyByIdError, UpdateArtToyData, UpdateArtToyResponse, UpdateArtToyError, ChangePasswordData, ChangePasswordResponse, ChangePasswordError, LoginData, LoginResponse, LoginError, LogoutData, LogoutResponse, LogoutError, MeData, MeResponse, MeError, PasswordResetRequestsData, PasswordResetRequestsResponse, PasswordResetRequestsError, RegisterData, RegisterResponse, RegisterError, ResetPasswordData, ResetPasswordResponse, ResetPasswordError, CreateCartData, CreateCartResponse, CreateCartError, AddItemToCartData, AddItemToCartResponse, AddItemToCartError, GetMyArtToysData, GetMyArtToysResponse, GetMyArtToysError, GetOrdersByStatusData, GetOrdersByStatusResponse, GetOrdersByStatusError, UpdateUserData, UpdateUserResponse, UpdateUserError } from './types.gen';
 ...
 */
export const createCart = <ThrowOnError extends boolean = false>(options?: Options<CreateCartData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<CreateCartResponse, CreateCartError, ThrowOnError>({
        url: '/v1/cart',
        ...options
    });
};
